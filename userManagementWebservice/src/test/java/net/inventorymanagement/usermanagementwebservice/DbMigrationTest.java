 ...
 * Uses MariaDB running @ localhost, create new temporary DB "test_usermanagement" and runs
...
public class DbMigrationTest {
    private String dbUsername = "usermanagement";
    private String dbPassword = "YOUR_SUPER_SECRET_PASSWORD";
    private String dbName = "test_usermanagement";
